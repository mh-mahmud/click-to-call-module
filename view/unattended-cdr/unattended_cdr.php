...
$grid->AddModelCustomSearchable('Date & Time', "sdate", 200, "center", "datetime");
$grid->SetDefaultValue("sdate", date("Y-m-d 00:00"), date("Y-m-d 23:59"));
...
$grid->AddSearhProperty("Status", "status", 'select', array_merge(['*' => 'All'], $cdr_status));

//$grid->AddModelNonSearchable("Stop time", "stop_time", 140, "center");
...
$grid->AddModelNonSearchable("Skill", "skill", 120, "center");
//$grid->AddModelNonSearchable("Hold in Queue", "hold_in_q", 120, "center");
//$grid->AddModelNonSearchable("Disc. Party", "disc_party", 120, "center");

$grid->AddModelNonSearchable("Status", "status", 120, "center");
// $grid->AddModel("Status", "status", 'select', "center");
...
<script>
    ...
    function autoRefreshList() {
        ...
        setTimeout("autoRefreshList()", 30000);
    }
</script>
